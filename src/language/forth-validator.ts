...
import type { ForthAstType, Forth } from './generated/ast.js';
...
export function registerValidationChecks(services: ForthServices) {
    ...
    const checks: ValidationChecks<ForthAstType> = {
        Forth: validator.checkPersonStartsWithCapital
    };
...
export class ForthValidator {
    ...
    checkPersonStartsWithCapital(forth: Forth, accept: ValidationAcceptor): void {
    //     if (person.name) {
